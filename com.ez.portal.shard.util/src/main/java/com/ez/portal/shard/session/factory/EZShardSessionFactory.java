package com.ez.portal.shard.session.factory;
...
public class EZShardSessionFactory {
    ...
    public EZShardSessionFactory configure() {
    ...
    public EZShardSessionFactory addEntityClass(Class<? extends Shardable> entityClass) {
